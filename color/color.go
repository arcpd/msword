...
func (_fb Color) AsRGBAString() *string {
	return _a.Stringf("\u0025\u00302\u0078\u0025\u00302\u0078\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", _fb._g, _fb._d, _fb._c, _fb._e)
}
...
func FromHex(s string) Color {
	...
	var _fe, _cb, _cg uint8
	_ec, _ := _f.Sscanf(s, "\u0025\u0030\u0032x\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", &_fe, &_cb, &_cg)
	if _ec == 3 {
		return RGB(_fe, _cb, _cg)
	}
	return Auto
}
...
func (_gg Color) IsAuto() bool { return _gg._aa }
...
// to a string containing a six digit hex RGB value.
func (_af Color) AsRGBString() *string {
	return _a.Stringf("\u0025\u0030\u0032x\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", _af._d, _af._c, _af._e)
}
